...
class CreatePartnerTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('partners', function (Blueprint $table) {
            ...
            // 娱乐城　配置
            $table->string('casino_platform_id',  128);
            $table->string('casino_site_id',  128);
        ...
        // 绑定总代
        Schema::create('partner_top_player', function (Blueprint $table) {
            $table->increments('id');
            $table->string('partner_sign', 64)->comment('商户标识');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('partner_top_player');
