...
class CreateBackendSystemLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('backend_system_logs', function(Blueprint $table)
		{
			...
			$table->integer('route_id')->unsigned()->nullable()->comment('路由id （backend_admin_routes表id）');
	...
	{
		Schema::drop('backend_system_logs');
	}
